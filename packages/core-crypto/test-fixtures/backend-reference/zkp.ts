 ...
 * `src/index.ts` or any app code; never ships in the mobile bundle.
 *
 * Provenance:
 *   Source repo:   https://github.com/sheikhhossainn/evoting-simulation
 *   Source path:   backend/src/crypto/zkp.ts
 *   Source commit: 22fd389c877ca5d16fd1d923bb1a5f92c6cd5717 (branch: main)
 *   Fetched:       2026-09-25
 *
 * See ./elgamal.ts in this same directory for why this file exists here and
 * how to refresh it — same process, same header conventions, kept in sync.
 *
