...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: colors.primary, fontSize: typography.eyebrow.fontSize, fontWeight: "800", letterSpacing: 2 },
  title: { color: colors.text, fontSize: typography.h1.fontSize, fontWeight: "800", lineHeight: typography.h1.lineHeight },
  sectionTitle: { color: colors.text, fontSize: typography.h2.fontSize, fontWeight: "800", marginBottom: spacing.xs },
  copy: { color: colors.textSecondary, fontSize: typography.body.fontSize, lineHeight: typography.body.lineHeight, marginBottom: spacing.sm },
  muted: { color: colors.textMuted, fontSize: typography.bodySm.fontSize, lineHeight: typography.bodySm.lineHeight },
  ...
  offlineText: { color: colors.textInverse, textAlign: "center", fontWeight: "700", fontSize: typography.bodySm.fontSize, flex: 1 },
